...
const Login = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			localStorage.setItem('RevNotes-token', data.token)
			setAuth(data)
			navigate('/admin')
		} catch (error) {
			setAlerta({
  ...
  return (
    <>
		...
		<main className="mt-11 container flex justify-center flex-col mx-auto">

			<div className="text-center m-5">
				<h1 className="titulo-registro">Inicia Sesión</h1>
			</div>
			...
			<div className=" formulario-container mt-30 md:mt-5 px-8 md:px-5 rounded-xl w-96 mx-auto ">
				...
				<div className="">
					...
					>
						<h1 className="links">Olvide mi Password</h1>
					</Link>
				</div>
			</div>
		</main>
